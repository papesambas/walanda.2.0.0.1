...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Publications::class, mappedBy: 'favoris')]
    private $favoris;
    ...
    public function addFavori(Publications $favori): self
    {
    ...
    public function removeFavori(Publications $favori): self
    {
