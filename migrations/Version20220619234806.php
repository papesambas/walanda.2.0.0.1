 ...
 */
final class Version20220619234806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publications CHANGE is_show is_afficher TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publications CHANGE is_afficher is_show TINYINT(1) NOT NULL');
    }
}
